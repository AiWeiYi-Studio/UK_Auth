...
<li class="<?php echo checkIfActive('ukyun')?>">
	<a href="javascript:void(0)" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-cubes sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">问题反馈</span></a>
	<ul>
<li>
...
<li>
	<a class="<?php echo checkIfActive('daima')?>" href="./daima.php">
		<i class="fa fa-book sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">代码大全</span>
	</a>
</li>

<li>
	<a class="<?php echo checkIfActive('login')?>" href="./login.php?logout">
		<i class="fa fa-sign-out sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">退出登录</span>
	</a>
</li>
