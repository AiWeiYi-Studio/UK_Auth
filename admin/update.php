...
?>
<div class="block">
<div class="block-title"><h3 class="panel-title">在线更新</h3></div>
<?php 
...
$DB->query("insert into `ukyun_log` (`uid`,`type`,`date`,`city`,`data`) values ('".$user."','更新程序(已成功)','".$date."','".$city."','IP:".$clientip."')");
