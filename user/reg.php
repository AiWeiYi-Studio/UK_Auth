...
$sql="insert into `auth_daili` (`user`, `pass`, `qq`, `active`, `power`, `name`, `boss`) values ('".$user."','".$pass."','".$qq."','1','5','".$name."','0')";
}
?>
<?php
if($rows){
...
$DB->query("insert into `auth_log` (`uid`,`type`,`date`,`city`,`data`) values ('".代理.$user."','注册账号','".$date."','".$city."','IP：".$clientip."|QQ：".$qq."')");
