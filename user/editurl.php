...
$DB->query("insert into `auth_log` (`uid`,`type`,`date`,`city`,`data`) values ('".代理.$user."','修改授权','".$date."','".$city."','IP：".$clientip."|QQ：".$qq."|域名：".$url."|授权码：".$authcode."')");
        exit("<script language='javascript'>alert('修改成功！');window.location.href='./urlslist.php';</script>");
...
<div class="card-body">
<form action="./editurl.php?my=edit&id=<?php echo $id; ?>" method="post" class="form-horizontal" role="form">
